...
#if DT_NODE_HAS_COMPAT_STATUS(DT_NODELABEL(plli2s), st_stm32f4_pll_clock, okay)
...
#if DT_NODE_HAS_COMPAT_STATUS(DT_NODELABEL(pllsai), st_stm32f4_pll_clock, okay)
...
#define STM32_PLLSAI_DIVR_ENABLED	DT_NODE_HAS_PROP(DT_NODELABEL(pllsai), r_divr)
#define STM32_PLLSAI_DIVR_DIVISOR	DT_PROP_OR(DT_NODELABEL(pllsai), r_divr, 1)
#endif
...
#if DT_SAME_NODE(DT_PLLI2S_CLOCKS_CTRL, DT_NODELABEL(clk_msis))
#define STM32_PLLI2S_SRC_MSIS	1
#endif
...
#if DT_SAME_NODE(DT_PLLSAI_CLOCKS_CTRL, DT_NODELABEL(clk_msis))
#define STM32_PLLSAI_SRC_MSIS	1
#endif
